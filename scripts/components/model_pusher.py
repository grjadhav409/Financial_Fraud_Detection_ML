...
from scripts.entity.artifact_entity import ModelPusherArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
from scripts.entity.config_entity import ModelEvaluationConfig,ModelPusherConfig
import os,sys
